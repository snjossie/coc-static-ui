export const Talents = [
    ...
    { 
        name: "Quick Healer",
        description: "Natural healing is increased to +3 hitpoints per day" 
    },
    { 
        name: "Night Vision",
        description: "In darkness, reduce the difficultly level of Spot Hidden rolls and ignore penalty die for shooting in the dark" 
    },
    { 
        name: "Endurance",
    ...
    { 
        name: "Iron Liver",
        description: "May spend 5 Luck to avoid the effects of drinking excessive amounts of alcohol (negating penalty applied to skill rolls)" 
    },
    { 
        name: "Stout Consitituion",
        description: "May spend 10 Luck to reduce poison or disease damage and effects by half" 
    },
    { 
        name: "Tough Guy",
        description: "Soaks up damage, may spend 10 Luck points to shrug off up to 5 hit points worth of damage taken in one combat round" 
    },
    { 
        name: "Keen Hearing",
    ...
    { 
        name: "Strong Willed",
        description: "Gain a bonus die when making POW rolls" 
    },
    { 
        name: "Quick Study",
    ...
    { 
        name: "Psychic Power",
        description: "May choose one psychic power (Clairvoyance, Divination, Medium, Psychometry, or Telekensis). Note that occupational and/or personal interest skill points should be invested in this skill (see Psychic Powers, page 83)" 
    },
    { 
        name: "Sharp Witted",
    ...
    { 
        name: "Outmaneuver",
        description: "Character is considered to have one point higher Build when initiating a combat maneuver (e.g. Build 1 becomes Build 2 when comparing their hero to the target in a maneuver, reducing the likelihood of suffering a penalty on their Fighting roll)" 
    },
    { 
        name: "Rapid Attack",
    ...
    { 
        name: "Handy",
        description: "Reduces difficulty by one level or gains bonus die (at the Keeper's discretion) when making Electrical Repair, Mechanical Repair, or Operate Heavy Machine rolls" 
    },
    { 
    ...
    { 
        ...
        description: "May spend 10 Luck points to gain a bonus die to Disguise or Art/Craft (Acting) rolls; includes ventriloquism (able to throw vo9ice over long distances so it appears that the sound is emanating from somewhere other than the hero). Note that if someone is trying to detect the disguise their Spot Hidden or Psychology rolls' difficulty is raised to Hard" 
    },
    { 
        name: "Resourceful",
